...
if st.session_state.df is not None:
    ...
    with row3_2:
        if user_choice == "左表":
            ...
            ax1.legend(handles=[red_line], labels=['Points nodata'], fontsize=20, loc='upper left', bbox_to_anchor=(0, 1.1))
            ax2.legend(handles=[brown_line], labels=['Rank nodata'], fontsize=20, loc='upper left', bbox_to_anchor=(0, 1.2))
            st.pyplot(fig)
